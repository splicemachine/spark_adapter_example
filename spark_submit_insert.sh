...
--jars "splicemachine-cdh5.12.2-2.2.0.cloudera2_2.11-2.5.0.1819-SNAPSHOT.jar" \
--class com.splicemachine.adapter.SpliceDriverInsert \
--master yarn --deploy-mode cluster --num-executors 12 --executor-memory 10G --executor-cores 4 spark_adapter_example-1.0.jar